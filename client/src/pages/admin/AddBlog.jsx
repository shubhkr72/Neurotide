...
const AddBlog = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1  text-gray-100 h-full overflow-scroll'>
      <div className='bg-blue-400/10 w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded-3xl text-white'>
        ...
        <p className='mt-4 text-white'>Blog Title</p>
        ...
        <p className='mt-4 text-white'>Sub Title</p>
        ...
        <p className='mt-4 text-white'>Author</p>
        <input type="text" placeholder='Linkedin ID' required className='w-full max-w-lg mt-2 p-2 border border-gray-300 outline-none rounded' onChange={e => setAuthor(e.target.value)} value={author}/>

        <p className='mt-4 text-white'>Blog Description</p>
        <div className='bg-gray-900/60 max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
            <div ref={editorRef}></div>
            {loading && ( 
            <div className='absolute right-0 top-0 bottom-0 left-0 flex items-center justify-center bg-black/50 mt-2'>
